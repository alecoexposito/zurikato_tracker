...
var adapter = function(device) {
    ...
    this.receive_alarm = function(msg_parts, device_id) {
	    ...
	    console.log(str);
        var orientation = str.substr(32, 4);
        var orientationDegrees = parseInt(orientation, 2);
        var data = {
            'device_id': device_id,
            ...
            'device_info': this.hex2bin(str.substr(54, 2)).substr(2, 3), // f.str_pad(parseInt(str.substr(54, 2)).toString(2), 8, 0),
