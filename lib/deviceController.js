...
module.exports = (scServer) => {
    class deviceController {
		...
		var args = {
                    ...
                    client.post("http://187.217.220.34:3007/api/v1/gps/coords", args, function (data, response) {});
                ...
                device.on("alert", function(alarm_code, alarm_data, msg_data) {
                   scServer.exchange.publish('alarms_'+alarm_data.device_id, alarm_data);
                    ...
                    client.post("http://187.217.220.34:3007/api/v1/alarms", args2, function (data, response) {
