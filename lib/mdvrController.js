            ...
            http.request(options, function (res) {
                ...
                res.on('data', function (data) {
                    ...
                    if(gpsData.latitude != "0.000000" || gpsData.longitude != "0.000000") {
                        if(this.lastData[deviceId] == undefined || this.lastData[deviceId] != gpsData.latitude + "," + gpsData.longitude) {
                            this.lastData[deviceId] = gpsData.latitude + "," + gpsData.longitude;
                            var args = {
        ...
        getVehicles() {
            ...
            http.request(options2, function (res2) {
                ...
                res2.on('data', function (data2) {
                    console.log("dentro del on data");
