    ...
    class bbController {
        ...
        run(options) {
                        ...
                        if(Array.isArray(gpsData)) {
                            ...
                            socket.write(JSON.stringify(reply), function(err) {
                                if(err) {
                                    ...
                                    console.log("received sent to bb");
                                }
                            });
                            ...
                            client.post(config.apiUrl + "/gps/coords", args, function (data, response) {
                                console.log("respuesta de la api coords: ", response.statusCode);
                            });
            ...
            videoBackupChannel.watch(function(data) {
                console.log("########### ENVIADO EN EL BACKUP CHANNELLLLL#####: ", data);
                ...
                if(data.type == "backup-file") {
                    ...
                    if(!fs.existsSync(playlistFile)) {
                        console.log("creando el fichero: ", playlistFile);
            ...
            // var bbPanicChannel = scServer.exchange.subscribe("bb_panic_channel");
            // bbPanicChannel.watch(function(data) {
